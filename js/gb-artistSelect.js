...
const initSortableList = (e) => {
  ...
  let nextSibling = siblings.find(sibling => {
    console.log("Comparing drag element at "+e.clientY+" to sibling "+sibling.textContent+" at "+  sibling.offsetTop + sibling.offsetHeight / 2 + " (offsetTop: "+ sibling.offsetTop+"; offsetHeight/2: "+sibling.offsetHeight/2);
